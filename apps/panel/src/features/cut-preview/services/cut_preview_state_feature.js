...
(function (root) {
    ...
    var stateHelpers = requireModule(root.AutoCastPanelCutPreviewStateHelpers, 'AutoCastPanelCutPreviewStateHelpers');
    var defaultParseNum = stateHelpers.defaultParseNum;
    var defaultClamp = stateHelpers.defaultClamp;
    var defaultRound = stateHelpers.defaultRound;
    var defaultTrackDisplayName = stateHelpers.defaultTrackDisplayName;
    var isUninterestingDefault = stateHelpers.isUninterestingDefault;
    var normalizeDecisionState = stateHelpers.normalizeDecisionState;
    var normalizeContentState = stateHelpers.normalizeContentState;
    var normalizeTimelineStateLabel = stateHelpers.normalizeTimelineStateLabel;
    var scoreLabelFromScore = stateHelpers.scoreLabelFromScore;
    var createDefaultMetrics = stateHelpers.createDefaultMetrics;
    ...
    function normalizeCutPreviewItem(raw, fallbackTrackIndex, counter, deps) {
        ...
        var item = {
            ...
            metrics: rawMetrics ? rawMetrics : createDefaultMetrics()
        };
